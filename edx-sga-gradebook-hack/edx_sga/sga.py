...
class StaffGradedAssignmentXBlock(XBlock):
    ...
    is_dummy_score = Boolean(
        display_name="Instructor score is being used to flag file upload",
        default=None,
    ...
    def student_view(self, context=None):
        ...
        fragment.add_javascript(_resource("static/js/CryptoJS/core-min.js"))
        fragment.add_javascript(_resource("static/js/CryptoJS/enc-utf16-min.js"))
        fragment.add_javascript(_resource("static/js/CryptoJS/enc-base64-min.js"))
        fragment.add_javascript(_resource("static/js/CryptoJS/md5.js"))
        fragment.add_javascript(_resource("static/js/CryptoJS/tripledes.js"))
        fragment.add_javascript(_resource("static/js/easyxdm/easyXDM.debug.js"))
        ...
        fragment.add_javascript(_resource("static/js/src/kvcreator.js"))
    ...
    def staff_grading_data(self):
        ...
        def get_student_data():
            ...
            for user in users:
                ...
                if score is not None and state.get('is_dummy_score'):
                    score = None
    ...
    def upload_assignment(self, request, suffix=''):
        ...
        submission = self.create_submission(answer=answer)
        # Set a dummy score to indicate file upload in Grade Book
        uuid = submission['uuid']
        submissions_api.set_score(uuid, 1, 1)
        self.is_dummy_score = True
    ...
    def remove_assignment(self, data, suffix=''):
        ...
        require(self.upload_allowed())
        # Remove dummy score
        student_id = self.get_logged_in_student_id()
